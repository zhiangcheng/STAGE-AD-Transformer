...
munge_sumstats.py \
 --sumstats adni_ad_male_sumstats_formatted_formetaanalysis.txt \
 --merge-alleles ${reference}w_hm3.noMHC.snplist \
 --snp rsID_build37 \
 --frq FREQA1 \
 --ignore MARKER_build37,MAF \
 --out Munged_sumstats/adni_ad_male_sumstats_formatted_formetaanalysis_LDSC_munged


# MSBB

munge_sumstats.py \
 --sumstats msbb_ad_male_sumstats_formatted_formetaanalysis.txt \
 --merge-alleles ${reference}w_hm3.noMHC.snplist \
 --snp rsID_build37 \
 --frq FREQA1 \
 --ignore MARKER_build37,MAF \
 --out Munged_sumstats/msbb_ad_male_sumstats_formatted_formetaanalysis_LDSC_munged


# ROSMAP

munge_sumstats.py \
 --sumstats rosmap_ad_male_sumstats_formatted_formetaanalysis.txt \
 --merge-alleles ${reference}w_hm3.noMHC.snplist \
 --snp rsID_build37 \
 --frq FREQA1 \
 --ignore MARKER_build37,MAF \
 --out Munged_sumstats/rosmap_ad_male_sumstats_formatted_formetaanalysis_LDSC_munged
