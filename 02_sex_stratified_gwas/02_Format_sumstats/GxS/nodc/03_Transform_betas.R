...
ADNI = paste0(directory, "adni_ad_GxS_nodc_sumstats_formatted_formetaanalysis.txt", sep = "")

ROSMAP = paste0(directory, "rosmap_ad_GxS_nodc_sumstats_formatted_formetaanalysis.txt", sep = "")

MSBB = paste0(directory, "msbb_ad_GxS_nodc_sumstats_formatted_formetaanalysis.txt", sep = "")
...
process_dataframe <- function(df, df_name, cases, controls, directory){
  ...
  output_file <- paste0(directory, "/", df_name, "_ad_GxS_nodc_sumstats_formatted_formetaanalysis_transformed.txt")
