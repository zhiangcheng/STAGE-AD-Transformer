...
mashr_eqtl_files=$(cat /media/desk15/iy2120/Project2026/Myproject_AD/03_spredixcan_eqtl_sqtl/temp/mashr_eqtl_files)
echo ${mashr_eqtl_files}

# Run the SPrediXcan analysis
for STUDY in ${gwas_imputed_files}
do
	for MODEL in ${mashr_eqtl_files}
	do
		...
		--output_file /media/desk15/iy2120/Project2026/Myproject_AD/03_spredixcan_eqtl_sqtl/output/spredixcan_eqtl_mashr/spredixcan_igwas_gtexmashrv8_${STUDY}__PM__${MODEL}.csv
	done
done
