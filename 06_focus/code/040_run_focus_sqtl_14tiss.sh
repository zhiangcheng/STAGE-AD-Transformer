...
do
	...
	do
		...
		"/media/desk15/iy2120/Project2026/Myproject_AD/06_focus/input/combined_dbs/14tiss_sqtl.db" \
		--verbose \
		--tissue Brain_Hippocampus \
		--p-threshold 1e-3 \
		--chr ${CHR} \
		--out "/media/desk15/iy2120/Project2026/Myproject_AD/06_focus/output/sqtl_focus_14tiss_${STUDY}_Chr${CHR}"
	done
done
